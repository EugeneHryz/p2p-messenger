...
class AndroidNetworkManager implements NetworkManager, Service {
	...
	private final AtomicReference<TaskScheduler.Cancellable> connectivityCheck =
			new AtomicReference<>();
	...
	private void scheduleConnectionStatusUpdate(int delay, TimeUnit unit) {
		TaskScheduler.Cancellable newConnectivityCheck =
				scheduler.schedule(this::updateConnectionStatus, eventExecutor,
						delay, unit);
		TaskScheduler.Cancellable oldConnectivityCheck =
